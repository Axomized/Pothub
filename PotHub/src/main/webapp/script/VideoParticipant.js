...
function startConnection() {
	...
	connection.open(window.eventName);
	...
	connection.onstreamended = function aaa() {
...
function connectToStream(username, topic) {
	const localUsername = encodeURI(username);
	const roomID = encodeURI(topic);
	$.ajax({
...
/* Hard to fix (Do it next time)(going to fake it)
function disconnectToStream(){
