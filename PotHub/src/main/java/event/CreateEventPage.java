...
public class CreateEventPage extends HttpServlet {
    ...
    public void init(ServletConfig config) throws ServletException{
		...
		sb.append("					<div id='eventname' class='col form-group'>");
		...
		sb.append("					</div>");
		sb.append("					<div id='maxamtofppt' class='col form-group'>");
		...
		sb.append("					</div>");
		sb.append("					<div id='postalcode' class='col form-group'>");
		...
		sb.append("					</div>");
		sb.append("				</div>");
		sb.append("				<div id='description-container' class='form-group row'>");
		...
		sb.append("					</div>");
		sb.append("				</div>");
		sb.append("				<div id='date-container' class='form-group'>");
		...
		sb.append("					</div>");
		sb.append("				</div>");
		sb.append("				<div id='gallery-container'>");
