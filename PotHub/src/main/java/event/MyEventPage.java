...
public class MyEventPage extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<!DOCTYPE html>"
				...
				+ "		<!-- My Own Script -->"
				+ "		<script src='script/MyEventPage.js'></script>"
				+ "		<!-- My Style Sheet -->"
				+ "		<link rel='stylesheet' type='text/css' href='css/MyEventPage.css' />"
				+ "	</head>"
				+ "	<body>"
				+ "		<!--  Navigation Bar -->"
				+ "		<div id='header'>"
				...
				+ "		</div>"
				+ "		<div id='wrapper'>"
				+ "			<button class='btn btn-success' id='createButton'>Create Event</button>"
				+ "			<div id='popup-container'>"
				+ "				<div id='popup'>"
				+ "					<div id='popup-title'>"
				+ "						<p><b>Ways to get privilege</b>"
				+ "					</div>"
				+ "					<div id='popup-icons' class='row'>"
				+ "						<div class='col-sm-6'>"
				+ "							<p><b>Being active on Forums</b></p>"
				+ "							<img src='images/forumIcon.png' alt='Forum Icon' width='100px' height=' 100px;'>"
				+ "						</div>"
				+ "						<div class='col-sm-6'>"
				+ "							<p><b>Donating to fund the website</b></p>"
				+ "							<img src='images/donationIcon.png' alt='Donation Icon' width='100px' height=' 100px;'>"
				+ "						</div>"
				+ "					</div>"
				+ "					<i class='fa fa-times-circle-o fa-2x' aria-hidden='true' id='closeBtn'></i>"
				+ "				</div>"
				+ "			</div>"
				+ "			<div class='content'>"
