...
public class EventPage extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		out.print("<!DOCTYPE html>" + "<html>" + "	<head>" + "		<meta charset='ISO-8859-1'>"
				...
				+ "			crossorigin='anonymous'>" + "		<title>Home Pages</title>"
				+ "		<!-- My Own Script -->" + "		<script src='script/'></script>"
				+ "		<!-- My Style Sheet -->"
				+ "		<link rel='stylesheet' type='text/css' href='css/EventPage.css' />" + "	</head>" + "	<body>"
