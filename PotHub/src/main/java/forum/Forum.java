...
public class Forum extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		out.println("<!DOCTYPE html>" + "<html>" + "<head>" + "<meta charset='ISO-8859-1'>" + "<meta name='viewport'"
				+ "	content='width=device-width, initial-scale=1, shrink-to-fit=no'>" + "<!-- Page Title -->"
				+ "<title>Forum</title>" + "<!-- Latest compiled and CSS -->" + "<link rel='stylesheet'"
				+ "	href='https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0-alpha.6/css/bootstrap.min.css'"
				+ "	integrity='sha384-rwoIResjU2yc3z8GV/NPeZWAv56rSmLldC3R/AZzGRnGxQQKnKkoFVhFQhNUwEyJ'"
				+ "	crossorigin='anonymous'>" + "<!-- Optional theme -->"
				+ "<script src='https://use.fontawesome.com/aff6d7353c.js'></script>" + "<!-- My Own Script -->"
				+ "<!-- <script src='script/'></script> -->" + "<!-- My Style Sheet -->"
				+ "<link rel='stylesheet' type='text/css' href='css/Forum.css' />" + "</head>" + "<body>"
				+ "	<!--  Navigation Bar -->" + "	<div id='header'>" + "		<div id='companyTitle'>"
				+ "			<h1>PotHub</h1>" + "		</div>" + "		<div id='profilePic'>"
				+ "			<img src='images/cat.png' height='50' width='50' />" + "		</div>" + "	</div>"
				+ "	<div id='navigation'>" + "		<ul>" + "			<li id='lhome'><a href='#00'>Home</a></li>"
				...
				+ "			<li id='ldonate'><a href='#04'>Donate</a></li>" + "		</ul>" + "	</div>"
				+ "	<div id='wrapper'>" + "		<div id='content-wrapper'>" + "			<div id='content'>"
				+ "				<div id='wholecomments'>" + "					<div id='test1'>"
				+ "						<div class='voting'>"
				+ "							<p style='text-align: center;'>"
				+ "								<img src='images/up.png' height='20' width='60' />"
				+ "							</p>" + "							<p style='text-align: center;'>5</p>"
				+ "							<p style='text-align: center;'>"
				...
				+ "							</div>" + "							<div id='name'>Chou Tzu Yu</div>"
				+ "							<div id='date'>5 hours ago</div>" + "						</div>"
				+ "					</div>" + "					<div id='test2'>"
				+ "						<div class='voting'>"
				+ "							<p style='text-align: center;'>"
				+ "								<img src='images/up.png' height='20' width='60' />"
				+ "							</p>" + "							<p style='text-align: center;'>19</p>"
				+ "							<p style='text-align: center;'>"
				+ "								<img src='images/down.png' height='20' width='60' />"
				+ "							</p>" + "						</div>"
				+ "						<div class='iconpic'>"
				...
				+ "							</div>" + "							<div id='name'>Eric Chou</div>"
				+ "							<div id='date'>10 hours ago</div>" + "						</div>"
				+ "					</div>" + "					<div id='test3'>"
				+ "						<div class='voting'>"
				+ "							<p style='text-align: center;'>"
				+ "								<img src='images/up.png' height='20' width='60' />"
				...
				+ "								<img src='images/tzuyu.jpg' height='70' width='70' />"
				+ "							</div>" + "							<div id='name'>Chou Tzu Yu</div>"
				+ "							<div id='date'>A year ago</div>" + "						</div>"
				+ "					</div>" + "				</div>" + "			</div>"
				+ "			<div id='content'></div>" + "		</div>" + "	</div>" + "	<div id='footer'>"
				+ "		<p>Copyright &copy; 2017 &ndash; 2018 PotHub. All rights reserved.</p>"
				+ "		<p>We like food</p>" + "		<p>"
				+ "			<a href='#'>Terms of Service</a> | <a href='#'>Privacy</a> | <a"
				+ "				href='#'>Support</a>" + "		</p>" + "	</div>"
