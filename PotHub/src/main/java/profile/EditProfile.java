...
public class EditProfile extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.print("<!DOCTYPE html>"
				...
				+ "										<span id='editProfileInfoSpan'>Change your password, gender, email, bio and address.</span>"
				+ "									</div>"
				+ "								</div>"
				+ "								<div id='passwordDiv'>"
				+ "									<div id='oldPassDiv'>"
				+ "										<label id='oldPassLabel' for='oldPassInput'>Old password</label>"
				+ "										<input type='password' id='oldPassInput' class='inputsForFill' name='oldPassInput' onkeyup='startedTyping(this)'>"
				+ "									</div>"
				+ "									<div id='newPassDiv'>"
				+ "										<label id='newPassLabel' for='newPassInput'>New password</label>"
				+ "										<input type='password' id='newPassInput' class='inputsForFill' name='newPassInput' onkeyup='startedTyping(this)'>"
				+ "									</div>"
				...
				+ "									<select id='genderSelect' class='custom-select' name='genderSelect'>"
				//+ "										<option selected disabled hidden='true'>Choose your gender</option>"
				+ "										<option selected disabled hidden='true'>" + gender + "</option>"
				...
				+ "									<textarea id='bioText' class='inputsForFill' name='bioText' onkeyup='startedTyping(this)'>" + bio + "</textarea>"
				+ "								</div>"
				+ "								<div id='addressDiv'>"
				+ "									<div id='postalCodeDiv'>"
				+ "										<label id='postalCodeLabel' for='postalCodeInput'>Postal Code</label>"
				+ "										<input type='text' id='postalCodeInput' class='inputsForFill' name='postalCodeInput' onkeyup='startedTyping(this)' value='" + address + "'>"
				+ "									</div>"
				+ "									<div id='unitNoDiv'>"
				+ "										<label id='unitNoLabel' for='unitNoInput'>Unit Number</label>"
				+ "										<input type='text' id='unitNoInput' class='inputsForFill' name='unitNoInput' onkeyup='startedTyping(this)' value='" + unitNo + "'>"
				+ "									</div>"
				+ "								</div>"
				+ "								<div id='updateBtnDiv'>"
