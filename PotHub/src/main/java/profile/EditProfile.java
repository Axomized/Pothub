...
public class EditProfile extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.print("<!DOCTYPE html>"
				...
				+ "									<input type='text' id='contactNoInput' class='inputsForFill' name='contacNoInput' onkeyup='startedTyping(this)'>"
				+ "								</div>"
				+ "								<div id='bioDiv'>"
				+ "									<label id='bioLabel' for='bioText'>Bio</label>"
				+ "									<textarea id='bioText' class='inputsForFill' name='bioText' onkeyup='startedTyping(this)'></textarea>"
				+ "								</div>"
				+ "								<div id='addressDiv'>"
				+ "									<div id='postalCodeDiv'>"
				+ "										<label id='postalCodeLabel' for='postalCodeInput'>Postal Code</label>"
				+ "										<input type='text' id='postalCodeInput' class='inputsForFill' name='postalCodeInput' onkeyup='startedTyping(this)'>"
				+ "									</div>"
				+ "									<div id='unitNoDiv'>"
				+ "										<label id='unitNoLabel' for='unitNoInput'>Unit Number</label>"
				+ "										<input type='text' id='unitNoInput' class='inputsForFill' name='unitNoInput' onkeyup='startedTyping(this)'>"
				+ "									</div>"
				+ "								</div>"
				+ "								<div id='updateBtnDiv'>"
