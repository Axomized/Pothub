	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		pw.append(
				"<!DOCTYPE html PUBLIC '-//W3C//DTD XHTML 1.0 Strict//EN' 'http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd'>"
						...
						+ "<div id='column1'>" + "<div class='row1 foodTitle'>Curry Shrimp</div>"
						+ "<div class='row1'>Big Matt, 4460CR</div>" + "</div>" + "<div id='column2'>"
						+ "<div class='row2'>6/6 Bids, 5pm 1-11-2018</div>" + "<div class='row2'>$12</div>" + "</div>"
						+ "<div id='column2'>" + "<div class='row2'>7.30pm</div>"
						+ "<div class='row3'>#12-34 Singapore, 465423</div>" + "</div>" + "</div>"
						+ "<div id='displayUnit' class='inactive'>"
						+ "<div id='thumbnailBox'><img height=100 width =100 src='images/crab.gif'></div>"
						+ "<div id='column1'>" + "<div class='row1 foodTitle'>Good Shrimp</div>"
						+ "<div class='row1'>Big Matt, 2370CR</div>" + "</div>" + "<div id='column2'>"
						+ "<div class='row2'>6/6 Bids, 5pm 1-10-2018</div>" + "<div class='row2'>$12</div>" + "</div>"
						+ "<div id='column2'>" + "<div class='row2'>7.30pm</div>"
						+ "<div class='row3'>#12-34 Singapore, 465423</div>" + "</div>" + "</div>"
						...
						+ "<div class='row1'>Big Matt, 3060CR</div>" + "</div>" + "<div id='column2'>"
						+ "<div class='row2'>6/6 Bids, 5pm 1-9-2018</div>" + "<div class='row2'>$12</div>" + "</div>"
						+ "<div id='column2'>" + "<div class='row2'>7.30pm</div>"
						+ "<div class='row3'>#12-24 Singapore, 465323</div>" + "</div>" + "</div>"
						+ "<div id='displayUnit' class='inactive'>"
						+ "<div id='thumbnailBox'><img height=100 width =100 src='images/crab.gif'></div>"
						+ "<div id='column1'>" + "<div class='row1 foodTitle'>7 Shots of Vodka Shrimp</div>"
						+ "<div class='row1'>Big Matt, 4060CR</div>" + "</div>" + "<div id='column2'>"
						+ "<div class='row2'>6/6 Bids, 5pm 1-8-2018</div>" + "<div class='row2'>$12</div>" + "</div>"
						+ "<div id='column2'>" + "<div class='row2'>7.30pm</div>"
						+ "<div class='row3'>#12-34 Singapore, 465423</div>" + "</div>" + "</div>"
						+ "<div id='displayUnit' class='inactive'>"
						+ "<div id='thumbnailBox'><img height=100 width =100 src='images/crab.gif'></div>"
						+ "<div id='column1'>" + "<div class='row1 foodTitle'>Amazing Shrimp</div>"
						+ "<div class='row1'>Big Matt, 2460CR</div>" + "</div>" + "<div id='column2'>"
						+ "<div class='row2'>6/6 Bids, 5pm 1-7-2018</div>" + "<div class='row2'>$12</div>" + "</div>"
						+ "<div id='column2'>" + "<div class='row2'>7.30pm</div>"
						+ "<div class='row3'>#12-34 Singapore, 465423</div>" + "</div>" + "</div>" + "</div>"
						+ "</div>" + "<div id='footer'>"
